...
1. Understand project context (CLAUDE.md)
...
Explore relevant directories based on the project's tech stack.
Look at existing patterns, naming conventions, and test structure.
